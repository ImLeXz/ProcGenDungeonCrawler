...
namespace ATDungeon.Dungeon.Testing
{
    ...
    public class HallGenerationTestFlipper : MonoBehaviour
    {
        [SerializeField]
        ...
        private void GenHallTest2(Vector3 startPos, Vector3 endPos)
        {
            ...
            if (xDir < 0)
            {
                ...
                Vector3 scale = new Vector3(-xLength - (width * 0.5f), thickness, width);
                Vector3 pos01 = cube_01.transform.position;
                Vector3 pos02 = cube_02.transform.position;

                cube_01.transform.position = new Vector3(pos01.x, pos01.y, this.transform.position.z - (width * 0.5f));
                cube_02.transform.position = new Vector3(this.transform.position.x - xLength - (width * 0.5f), pos02.y, this.transform.position.z);
            ...
            if (zDir < 0)
            {
                ...
                Vector3 pos01 = cube_02.transform.position;

                Vector3 scale = Vector3.zero;
                

                scale = new Vector3(width, thickness, -(zLength) + (width * 0.5f));

                CreateCube(cube_02, scale, false, true);
                cube_02.transform.position = new Vector3(pos01.x, pos01.y, this.transform.position.z - (width *0.5f));
            }
            ...
            else
            {
                ...
                Vector3 scale = new Vector3(width, thickness, zLength - (width * 0.5f));
